...
<div id="search" class="s-search">
    ...
    <form action="?s=" method="get" target="_blank" id="super-search-fm"><input type="text" id="search-text" placeholder="输入关键字搜索" style="outline:0"><button type="submit" onclick="encoderForSearch()"><i class="fa fa-search "></i></button></form>
    <div class="set-check hidden-xs">
        <input type="checkbox" id="set-search-blank" class="bubble-3" autocomplete="off">
    </div>
</div>
<script type="text/javascript">
    function encoderForSearch() {
    document.getElementById("search-text").value = encodeURIComponent(document.getElementById("search-text").value)
}
